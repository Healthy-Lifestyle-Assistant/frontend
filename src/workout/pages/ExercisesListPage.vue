<template>
    ...
    <div class="d-flex flex-column align-items-start">
        ...
        <div v-if="exercises && exercises.length > 0" class="d-flex flex-row flex-wrap">
...
import { EXERCISES, EXERCISES_DEFAULT, BODY_PARTS } from "@/shared/URL";
    ...
    methods: {
        async onPageRequest(event, pageNumber) {
            ...
            if (isLogged) {
                ...
                response = await this.getDefaultAndCustomExercises(urlString, token);
            } else {
        ...
        async getDefaultAndCustomExercises(urlParams, token) {
