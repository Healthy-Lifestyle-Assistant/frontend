<template>
    <div class="w-100">
        ...
        <ButtonComponent :link="generateLinkForSetupReminderButtom()" title="Setup Reminder" class="mt-4 me-2"/>
...
export default {
    ...
    methods: {
        ...
        generateLinkForSetupReminderButtom() {
            return `/workouts-setup-reminder/${this.id}`;
        }
    }
}
</script>